 ...
 */
class CreateCategoryFormProcessing extends BaseFormProcessing implements FormProcessing {
     ...
     *
     * @param  The command bus object   $createCategoryCommand
     * @return The custom response array
     */
    public function quarterback($createCategoryCommand) {

        // Get inputs into array
        $data = (array) $createCategoryCommand;
