 ...
 */
class DeleteTagFormProcessing extends BaseFormProcessing implements FormProcessing {
     ...
     */
    public function quarterback($deleteTagCommand) {

        // Get inputs into array
        $data = (array) $deleteTagCommand;
    ...
    public function isForeignKeyOk($data){
        $count = $this->repository->countAllPostsThatHaveTagId($data['id']->id);
